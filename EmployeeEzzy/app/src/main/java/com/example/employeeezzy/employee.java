    ...
    private class Async extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://studentezzy.000webhostapp.com/select_stu.php");
            ...
            if(check.matches("1"))
            {
                ...
                try {
                    ...
                    for (int i=1;i<r2.length();i++) {
                        ...
                        String r5=jsonObject.getString("div");
                        String r6=jsonObject.getString("stu");
                        ID_Array.add(r3);
                        NAME_Array.add(r4);
                        SALARY_Array.add(r5);
                        DIV.add(r6);
                    }
                    listAdapter = new com.example.employeeezzy.ListAdapter(getActivity(),
